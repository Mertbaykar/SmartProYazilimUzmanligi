...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    public class istatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d11 = deger11;
            var deger12 = c.Uruns.GroupBy(x => x.Marka).OrderByDescending(y => y.Count()).Select(z => z.Key)
                .FirstOrDefault();   
            // Key: Ulaşılan değerin en başta belirttiğimiz Marka ismi, yani neye göre gruplandırdıysak o key değerdir.
            ViewBag.d12 = deger12;
            var deger13 = c.Uruns.Where(u=>u.Urunid == (c.SatisHarekets.GroupBy(x => x.Urunid).OrderByDescending(y => y.Count()).Select(z => z.Key)
